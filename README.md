...
🔗 [Ver Web Portfolio QA](https://kareliaqaorganization.github.io/portfolio-qa-kz/)
...
- Proyecto Supabase (requiere acceso): [Supabase Project](https://supabase.com/dashboard/project/qsnehbtnfnuzibidrfqo)  

## 🗄 API de Formulario
Se ha generado una API que permite agregar, editar, consultar y eliminar datos de la base de datos creada en supabase.
- URL API (requiere acceso): [Supabase API](https://qsnehbtnfnuzibidrfqo.supabase.co/rest/v1/form)  
- Documentación de la API: [Documentación API](https://kareliaqaorganization.github.io/portfolio-qa-kz/apidoc.html) 
---
...
### Pruebas de API
- Colección en POSTMAN (requiere acceso): [POSTMAN Collection](https://planetary-spaceship-768528.postman.co/workspace/form~1913aa4c-7090-4c53-9636-60ea072fe9a2/collection/53484431-5d73b4da-d8af-4c6d-b19d-012ba2af15d9?action=share&source=copy-link&creator=53484431) 
